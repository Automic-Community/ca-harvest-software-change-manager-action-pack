...
###### Description
 CA Harvest Software Change Manager is a release management solution that provides powerful, process-driven capabilities for managing development teams across your enterprise.. [Check the Feature support by action pack](source/README.md)
...
###### Prerequisite:
	...
	4. **Keep the be jars in the given directory tree structure. Here harvest_lib is parallel to src directory**.
	    a. **harvest_lib > harvest > cmsdk > 12.6 > cmsdk-12.6.jar**
        b. **harvest_lib > haragent > haragent > 12.6 > haragent-12.6.jar**
        c. **harvest_lib > haragent > hcomm > 12.6 > hcomm-12.6.jar**
        d. **harvest_lib > haragent > hcontainer> 12.6 > hcontainer-12.6.jar**
        e. **harvest_lib > haragent > hutils > 12.6 > hutils-12.6.jar**
